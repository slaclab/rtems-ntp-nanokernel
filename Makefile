...
C_PIECES=ktime rtemsdep $(C_PIECES_USE_MICRO_$(USE_MICRO)) $(C_PIECES_USE_PICTIMER_$(USE_PICTIMER))
C_FILES=$(C_PIECES:%=%.c)
...
DEFINES_USE_DECREMENTER_YES=-DUSE_DECREMENTER
...
DEFINES  += $(DEFINES_USE_DECREMENTER_$(USE_DECREMENTER))
CPPFLAGS +=
CFLAGS   +=
